angular.module('appTemplatesKasko', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("js/src/modules/carFilterC/views/first_big_step.html",
    ...
    "\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-exploitation_area\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-car_cost\">\n" +
    "        <div class=\"fields\">\n" +
    "            <div class=\"five wide field nowrap\">\n" +
    "                <label for=\"id_car_cost\">Укажите стоимость автомобиля в руб.:</label>\n" +
    "\n" +
    "                <input type=\"text\"\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-mileage\">\n" +
    "        <div class=\"fields\">\n" +
    "            <div class=\"five wide field nowrap\">\n" +
  ...
  $templateCache.put("js/src/modules/carFilterC/views/fourth_big_step.html",
    ...
    "                                    | priceFormatter:0:'':false\"></span>.<small ng-bind=\"carFilterParams.selectedResult().program.sum\n" +
  ...
  $templateCache.put("js/src/modules/carFilterC/views/program_list.manager.html",
    ...
    "                                ng-disabled=\"!postCalculateParams.manager__client_name || !clientParams.manager__client_phone || postCalculateParams.button_is_disabled\"\n" +
  ...
  $templateCache.put("js/src/modules/carFilterC/views/second_big_step.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-drivers_count\">\n" +
    "        <h2 class=\"b-content_title mb20\">Выберите количество водителей:</h2>\n" +
    "\n" +
    "        <div class=\"five ui basic blue buttons\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-drivers css-bigger-labels css-bigger-slider\">\n" +
    ...
    "                <button class=\"ui button green\" type=\"button\">Далее</button>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-multidrive css-bigger-labels css-bigger-slider\">\n" +
    "        <div class=\"ui grid three column mt20 doubling stackable\"\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-is_earlier_insurance\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-is_credit\">\n" +
    "        <h3 class=\"b-content_title mb20 mt30\">Куплен в кредит?</h3>\n" +
    "        <div class=\"ui grid\">\n" +
    "            <div class=\"row\">\n" +
    "                <div class=\"eight wide column\">\n" +
    "                    <div class=\"field\" align=\"left\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-contributory_scheme\">\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div class=\"c-hidden show-active-antitheft\">\n" +
  ...
  $templateCache.put("js/src/modules/carFilterC/views/third_big_step.html",
    ...
    "    <div class=\"column\">\n" +
    "      <h4>\n" +
    "        На следующем шаге Вы получите результаты расчетов стоимости КАСКО в различных страховых компаниях. Пройдите, пожалуйста,\n" +
    "        бесплатную sms-верификацию.\n" +
    "      </h4>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "    <div class=\"row\">\n" +
    ...
    "                        type=\"button\">Показать тарифы</button>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    ...
    "               ng-click=\"clientParams.sms_is_visible = false;\">Изменить номер телефона</a>\n" +
    "        </div>\n" +
    "\n" +
    "        <div class=\"column\">\n" +
  ...
  $templateCache.put("js/src/modules/preCalculatorC/views/pre_calculator.rolf.html",
    ...
    "                  class=\"ui button right floated branded\">\n" +
    "            Далее\n" +
    "          </button>\n" +
    "        </div>\n" +
    "      </div>\n" +
  ...
  $templateCache.put("js/src/modules/calculatorC/views/kasko/calculation.program_list.html",
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"ui form b-full-width-bg_white mt50\"\n" +
    ...
    "              <!--<i class=\"icon warnging\"></i>--><span>Лучшая цена!</span>\n" +
    "            </div>\n" +
    "\n" +
    "            <div class=\"b-result-kasko_head\" title=\"{{result.insurance_company.title}}\">\n" +
